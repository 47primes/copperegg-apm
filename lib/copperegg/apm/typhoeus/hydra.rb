...
if defined?(::Typhoeus::Hydra) &&
   defined?(::Typhoeus::VERSION) &&
   ::Typhoeus::VERSION =~ /\A0\.3\.?/
  module Typhoeus
    class Hydra
      include CopperEgg::APM::Typhoeus::Hydra
      alias handle_request_without_ce_instrumentation handle_request
      alias handle_request handle_request_with_ce_instrumentation
    end
  end
end
